            ...
            <div className='flex items-center font-serif space-x-2.5'>
              ...
              {quest.fields.project_link 
                ? <Link href={`${quest.fields.project_link}`}>
                    <a target="_blank" rel="noreferrer" className='text-gray-800 text-xl underline decoration-1 decoration-dashed hover:decoration-solid hover:decoration-gray-900 underline-offset-4'>{quest.fields.project.trim()}</a>
                  </Link>
