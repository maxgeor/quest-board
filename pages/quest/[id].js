    ...
    <>
      ...
      <div className='w-full max-auto sm:pb-24'>
        <header className='flex justify-center my-10'>
          <Link href='/'>
            <div className='shadow-inner board-logo bg-board flex flex-col items-center cursor-default pt-4 pb-5 px-6 transition duration-75 hover:scale-101 md:active:scale-100 transform -rotate-1 hover:-rotate-2 border-4 border-board-logo-border hover:border-gray-700 rounded-md hover:bg-gray-800 w-min'>
