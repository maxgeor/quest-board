    ...
    <>
      ...
      <div className='w-full max-auto sm:pb-24'>
        <header className='flex justify-center my-10'>
          <Link href='/'>
            <div className='shadow-inner board-logo bg-board flex flex-col items-center cursor-default pt-4 pb-5 px-6 transition duration-75 hover:scale-101 md:active:scale-100 transform -rotate-1 hover:-rotate-2 border-4 border-gray-700/75 hover:border-gray-700 rounded-md hover:bg-gray-800 w-min'>
        ...
        <main className={`py-8 pb-40 px-6 sm:px-16 mx-auto min-h-[110vh] h-full flex flex-col items-center bg-gray-200 text-gray-900 sm:max-w-3xl rounded-xl rounded-b-none sm:rounded-b-xl shadow-2xl`}>
          ...
          <div className='w-full relative h-full space-y-8'>
            ...
            <div className='text-xl flex flex-wrap items-center justify-center space-y-1 space-x-4'>
