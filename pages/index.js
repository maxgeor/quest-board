  ...
  return (
    <>
      ...
      <div className={`text-gray-200 bg-black min-h-screen font-serif pb-40`}>
        ...
        <main className='board bg-board w-full md:max-w-5xl sm:rounded-xl shadow-2xl min-h-screen sm:min-h-[80vh] lg:min-h-screen border-12 border-x-0 sm:border-x-12 mx-auto border-gray-800 p-4 sm:p-6'>
          <div className='w-full mx-auto grid grid-cols-1 md:grid-cols-2 auto-rows-min gap-4 sm:gap-6'>
            <a href="https://airtable.com/shrTGIIyaOSSMAoYd" target="_blank" rel="noreferrer" className='transition duration-75 hover:scale-101 h-48 md:h-56 space-y-6 flex flex-col items-center shover:scale-101 md:active:scale-100 transform -rotate-0.25 hover:-rotate-1 hover:border-gray-600 rounded-md justify-center border-4 border-gray-700 border-dashed bg-gray-800 text-gray-300 hover:text-gray-100 p-6 py-10 lg:p-8 cursor-default'>
