  ...
  return (
    <>
      ...
      <div className={`w-full text-gray-200 bg-black min-h-screen font-serif pb-40`}>
        ...
        <main className='shadow-inner board bg-board w-full sm:max-w-lg md:max-w-5xl sm:rounded-xl min-h-screen sm:min-h-[80vh] md:min-h-screen border-12 border-x-0 sm:border-x-12 mx-auto border-gray-800 p-4 sm:p-6'>
