  ...
  return (
    <>
      ...
      <div className={`text-gray-200 bg-black min-h-screen font-serif pb-40`}>
        ...
        <main className='board bg-board w-full md:max-w-5xl sm:rounded-xl shadow-2xl min-h-screen border-12 border-x-0 sm:border-x-12 mx-auto border-gray-800 p-4 sm:p-6'>
